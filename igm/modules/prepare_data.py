...
def init_prepare_data(params,self):
    ...
    if params.observation:
        ...
        thkinit     = np.flipud(np.squeeze(nc.variables['millan_ice_thickness']).astype("float32"))
    ...
    if params.observation:        
        vars_to_save += ["usurfobs","thkobs","icemaskobs","uvelsurfobs","vvelsurfobs","thkinit"]
